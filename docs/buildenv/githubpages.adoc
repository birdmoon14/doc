...
image::docs/images/screenshot-ruby-download.png[]

==== Rubyをインストール

image::docs/images/screenshot-ruby-install-01.png[]
 「I accept the License」を選択して「Next」

image::docs/images/screenshot-ruby-install-04.png[]
 インストールフォルダを選択。PATHも通してくれる。

WARNING: デフォルトで設定されている値がドライブ名だけ（ex.「D」）になっている場合があるため、インストールフォルダはよく確認（必要な場合は作成）して選択すること。

image::docs/images/screenshot-ruby-install-05.png[]
 すべて選択されているので、問題がなければそのまま次へ

image::docs/images/screenshot-ruby-install-06.png[]
 インストール完了

image::docs/images/screenshot-ruby-install-07.png[]
 ターミナルでもバージョンを確認できた
